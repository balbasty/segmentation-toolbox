...
% 2D
% im{end + 1} = {'/data-scratch/mbrud/images/2D-Data/CT-aged-2D-den',S,'CT','healthy',''};
% im{end + 1} = {'/data-scratch/mbrud/images/2D-Data/CT-CHROMIS-2D-den',S,'CT','healthy',''};
% im{end + 1} = {'/data-scratch/mbrud/images/2D-Data/CT-healthy-2D-den',S,'CT','healthy',''};
